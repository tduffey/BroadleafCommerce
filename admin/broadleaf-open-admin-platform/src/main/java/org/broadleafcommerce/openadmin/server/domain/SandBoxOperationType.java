...
public class SandBoxOperationType implements Serializable, BroadleafEnumerationType {
    ...
    public static final SandBoxOperationType REVERT_FOR_PROMOTE = new SandBoxOperationType("REVERT_FOR_PROMOTE", "Revert For Promote");
    public static final SandBoxOperationType REVERT_FOR_REJECT = new SandBoxOperationType("REVERT_FOR_REJECT", "Revert For Reject");
